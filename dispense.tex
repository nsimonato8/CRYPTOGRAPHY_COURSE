...
\chapter{Efficient implementations of elementary operations and elements of Number Theory}
\section{Notation}
\begin{itemize}
...
An efficient way of computing the modular inverse of a given number $a$ with in the ring $\mathbb{Z}_{m}$ uses the corollary of the \emph{Bezout identity} and the \emph{Extended Euclidean Algorithm}.\newline
...
\begin{itemize}
    ...
    \item \therefore $x$ is the modular inverse of $a$ in $\mathbb{Z}_{m}$ for its definition.
\end{itemize}
